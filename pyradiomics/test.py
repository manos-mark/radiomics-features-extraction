...
if __name__ == '__main__':
    ...
    DATASET_PATH = '/home/manos/git/radiomics-features-extraction/test_image_files'#os.path.join('data', 'dataset')
    OUTPUT_PATH = os.path.join('data', 'test_image_pyradiomics_extracted_features.csv')
